...
ratioY = (intptr_t)param >> 8 & 0xFF;
ratioX = (intptr_t)param & 0xFF;
...
float focal =   (intptr_t)param >> 8 & 0xFF; // focal point of lens
float obj_dis = (intptr_t)param & 0xFF;      // distance of object from focal point.
